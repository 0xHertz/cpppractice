...
static void on_startup(GApplication *application){
    ...
    g_signal_connect(btn_open, "clicked", G_CALLBACK(open_cb), app);
    g_signal_connect(btn_save, "clicked", G_CALLBACK(save_cb), app);
    g_signal_connect(btn_new, "clicked", G_CALLBACK(new_cb), app);
    g_signal_connect(btn_close, "clicked", G_CALLBACK(close_cb), app);
    // cancel ref builder
